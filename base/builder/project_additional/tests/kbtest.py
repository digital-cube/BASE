...
class TestKB(TestKBase):
    ...
    def test_0(self):
        ...
        r = self.api(token_user, 'PUT', '/api/wiki/posts', body={'title': 'neki tamo naslov',
                                                                 'body': '<p>tekst</p>',
                                                                 'tags': ['telmekom','test', 'showTag', 'abc', 'Abc', 'ABc']
                                                                 }, expected_status_code=200)
        self.assertTrue('id' in r)
        _id = r['id']

        r = self.api(token_user, 'PUT', '/api/wiki/posts/{}/files'.format(_id), body={'filename': 'doc.doc', 'local_name': '3fd75bac-62a9-4eaa-b087-06a5e1ca096c.doc'}, expected_status_code=200)
        self.api(token_user, 'PUT', '/api/wiki/posts/{}/files'.format(_id), body={'filename': 'pera.xls', 'local_name': '3fd75bac-62a9-4eaa-b087-06a5e1ca096c.xls'}, expected_status_code=200)
        self.api(token_user, 'PUT', '/api/wiki/posts/{}/files'.format(_id), body={'filename': 'zika.doc', 'local_name': '3fd75bac-62a9-4eaa-b087-06a5e1ca096c.doc'}, expected_status_code=200)
        self.api(token_user, 'PUT', '/api/wiki/posts/{}/files'.format(_id), body={'filename': 'arhiva.zip', 'local_name': '3fd75bac-62a9-4eaa-b087-06a5e1ca096c.zip'}, expected_status_code=200)
...
class TestFilesUpload(TestKBase):
...
class TestUserGetPosts(TestKBase):
